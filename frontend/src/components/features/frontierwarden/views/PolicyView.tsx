...
import { GatePassagePreviewPanel } from './GatePassagePreviewPanel';
...
export function PolicyView({ data, live = false, loading = false, error = null, provenance }: Props = {}) {
  ...
  return (
    <>
      ...
      <GatePassagePreviewPanel
        policy={policy}
        pilot={pilot}
        selectedGate={selectedGate}
        standingProof={standingProof}
        allowed={allowed}
        decision={decision}
        score={score}
        threshold={threshold}
      ...
      <div style={{
        ...
        <div style={{
          ...
          <label htmlFor="policy-ally-threshold">
            <div className="c-policy__label">Ally Threshold</div>
            <input
              id="policy-ally-threshold"
              name="policy-ally-threshold"
              className="c-input"
              inputMode="numeric"
              min={0}
              step={1}
