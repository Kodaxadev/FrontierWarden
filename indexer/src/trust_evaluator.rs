...
use crate::trust_types::{
    ...
    REASON_ALLOW_FREE, REASON_ALLOW_TAXED, REASON_BOUNTY_TRUST_INSUFFICIENT_DATA,
    ...
    REASON_DENY_COUNTERPARTY_SCORE_TOO_LOW, REASON_DENY_NO_STANDING_ATTESTATION,
    REASON_DENY_SCORE_BELOW_THRESHOLD, REASON_ERROR_GATE_NOT_FOUND, REASON_ERROR_UNSUPPORTED_ACTION,
};
...
pub async fn evaluate_bounty_trust(
    pool: &PgPool,
    req: TrustEvaluationRequest,
    default_bounty_schema: &str,
) -> Result<TrustEvaluationResponse> {
